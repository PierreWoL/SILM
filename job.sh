...
#$ -pe smp.pe 2      # 8 CPU cores available to the host code
...
datasets=("WDC")
#check_subject_Columns=("subjectheader" "Subjectheader" "header" "none") 
#table_orders=("sentence_row" "pure_row" "column")  
