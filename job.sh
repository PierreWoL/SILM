...
#$ -pe smp.pe 4    # 8 CPU cores available to the host code "subjectheader" "header" "none"
                     # Can use up to 12 CPUs with an A100 GPU. open_data "pure_row" "sentence_row"
module load libs/cuda
conda activate py39
source /mnt/iusers01/fatpou01/compsci01/c29770zw/test/CurrentDataset/datavenv/bin/activate
datasets=("open_data")
check_subject_Columns=("subjectheader") 
table_orders=("sentence_row")  
