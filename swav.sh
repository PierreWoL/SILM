...
module load mpi/intel-18.0/openmpi/4.0.1-cuda-ucx
...
#export PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:128 --header \
...
#for num in "${nums[@]}"
  #do
    EXPERIMENT_PATH="./model/swav/$dataset/sbert/-1/20/queue_0/num500/"
